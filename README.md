...
5. Run `npm i` in order to install the dependencies
## Usage
Once you've done the initial setup, simply open a terminal in the destination folder and run `node index.js`